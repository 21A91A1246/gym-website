  ...
  if (validateloginForm()) { // Corrected: Call the function
    try {
      ...
      const response = await axios.post(
        "https://gym-website-phug.onrender.com/login",
        formDataL
      );
    ...
    const handleSignupSubmit = async (e) => {
      ...
      if (validateForm()) {
        try {
          ...
          const response = await axios.post(
            "https://gym-website-phug.onrender.com/signup",
    ...
    const handleForgotSubmit = (e) => {
      ...
      axios.put('https://gym-website-phug.onrender.com/forgot', {formDataF})
          .then((res) => {
              Swal.fire({
                  title: "Success",
                  text: res.data.msg,
        ...
        <div className="container mx-auto px-4 py-10">
            {currentView === 'login' && (
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="text-black-500 hover:text-black-600 font-medium hover:underline"
                  >
                    Forgotten password?
                  </button>
                </div>
                <div className="mt-8">
                  <button
                    type="button"
                    className="w-full bg-black-500 text-black font-bold p-3 rounded-lg shadow-lg hover:bg-black-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-black-400"
            ...
            {currentView === 'forgot' && (
                ...
                <div className="space-y-5">
                  <div className="relative">
                    <input
                      type="email"
                      placeholder="Email Address"
                      className="w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-black-400"
                ...
                <div className="mt-8">
                  <button
                    type="button"
                    className="w-full bg-grey-200 text-black font-bold p-3 rounded-lg shadow-lg hover:bg-grey-300 transition duration-300 focus:outline-none focus:ring-2 focus:ring-black-400"
